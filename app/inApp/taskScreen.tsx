...
return (
  <SafeAreaView
    ...
    accessibilityHint="Displays task details including title, description, assignee and subtasks"
  >
    <TopBar />
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <Text
        ...
        accessibilityLabel={`Team name: ${params.team_name}`}
      >
        {params.team_name}
      </Text>
      ...
      <Text
        ...
        accessibilityRole="header"
        accessibilityLabel={`Task name: ${params.task_name}`}
      >
        {params.task_name}
      </Text>

      <View style={styles.assignContainer} accessible={true} accessibilityLabel={`Task assigned to ${assignedMember}`}>
        <MaterialIcons name="account-circle" size={30} color={theme.text} />
        <Text
          style={[styles.assignedText, { color: theme.text }]}
        ...
        {(userRole === 'owner' || userRole === 'admin' || params.user_id === params.task_assigned_to) && (
          <TouchableOpacity
            onPress={() => setShowRoleOptions(prevState => ({ ...prevState, [String(params.task_assigned_to)]: true }))}
            style={{ marginLeft: 10 }}
            accessibilityRole="button"
            accessibilityLabel="Edit task assignee"
          >
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={[styles.modalContainer, { backgroundColor: theme.card }]}>
                ...
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <TouchableOpacity
                      ...
                      accessibilityRole="button"
                      accessibilityLabel={`Assign to ${item.username}`}
                    >
              ...
              <TouchableOpacity onPress={() => setShowRoleOptions({})} accessibilityRole="button" accessibilityLabel="Cancel assignment">
      ...
      <View
        style={{ width: '100%', justifyContent: 'flex-start', alignItems: 'center', flexDirection: 'row' }}
        accessible={true}
        accessibilityRole="text"
        accessibilityLabel={`Deadline: ${params.task_deadline}`}
      >
        <Text style={[styles.subsubHeader, { color: theme.text, marginBottom: 0 }]}>Deadline:</Text>
      </View>

      <Text
        style={[styles.description, { color: theme.text, fontSize: 12, marginVertical: 0 }]}
        accessibilityRole="text"
      >
      ...
      <View
        style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: '100%', marginBottom: 10 }}
        accessible={true}
        accessibilityLabel="Task description section"
      >
        <Text style={[styles.subHeader, { color: theme.text }]}>Description</Text>
        <TouchableOpacity
          onPress={speakDescription}
          accessibilityRole="button"
          accessibilityLabel="Read task description out loud"
        >
      ...
      <Text
        ...
        accessibilityRole="text"
        accessibilityLabel={`Description: ${params.task_description}`}
      >
        {params.task_description}
      </Text>

      <View style={{ width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start' }} accessible={true} accessibilityLabel="Subtasks section">
      ...
      <FlatList
        ...
        accessibilityLabel="List of subtasks"
      />

      <View
        style={[styles.statusContainer, { marginBottom: 80 }]}
        accessible={true}
      ...
      >
        <TouchableOpacity
          ...
          accessibilityState={{ checked: mainTask?.completed }}
        >
