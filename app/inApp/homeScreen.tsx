...
export default function HomeScreen() {  
  ...
  return (
    <SafeAreaView
      ...
      accessible={true}
      accessibilityLabel="Teams screen"
      accessibilityHint="View and manage your teams"
    >
      <TopBar />
      ...
      <View
        ...
        accessible={true}
        accessibilityLabel="Teams header"
      ...
      >
        ...
        <TouchableOpacity
          ...
          accessibilityHint="Navigates to screen for creating a new team"
          accessibilityLanguage="en-US"
        >
      ...
      <ScrollView
        ...
        accessibilityLabel="List of your teams"
        accessibilityLanguage="en-US"
      >
        {teams.length > 0 ? (
          teams.map(team => (
            <TouchableOpacity
              ...
              accessibilityHint="Navigates to team workspace"
              accessibilityLanguage="en-US"
            >
              <Text
                style={[styles.teamButtonText, { color: theme.text }]}
          ...
          <Text
            ...
            accessibilityRole="text"
            accessibilityLabel="You are not a member of any team yet"
            accessibilityLanguage="en-US"
          >
