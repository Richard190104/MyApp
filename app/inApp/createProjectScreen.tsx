...
export default function CreateProjectScreen() {
  ...
  return (
    <SafeAreaView
      ...
      accessible={true}
      accessibilityLabel="Create project screen"
      accessibilityHint="Fill in project name and deadline to create a new project"
    ...
    >
      ...
      >
        ...
        {errors.name && (
          <Text
            ...
            accessibilityLabel="Project name is required"
      ...
      <View
        style={styles.inputRow}
        accessible={true}
        accessibilityLabel="Project deadline input"
      ...
      >
        <TextInput
          ...
          accessibilityLabel="Project deadline"
          accessibilityRole="text"
        ...
        {errors.description && (
          <Text
            style={styles.errorIcon}
            accessibilityLabel="Deadline is required"
            accessibilityRole="alert"
          >
            ❌
          </Text>
      ...
      <TouchableOpacity
        ...
        accessibilityHint="Creates a new project with provided name and deadline"
        accessibilityLanguage="en-US"
        accessibilityState={{ disabled: isLoading }}
      >
        <Text
          style={[styles.createButtonText, { color: theme.text }]}
          accessibilityLanguage="en-US"
        >
          Create Project
        </Text>
