...
const modifyTaskStatus = async (task: any) => {
  ...
  if (state.isConnected) {
    ...
    <SafeAreaView
        ...
        accessible={true}
        accessibilityLabel="Project screen"
        accessibilityHint="Displays project progress and tasks"
    ...
    >
        ...
        accessibilityLabel={`Team name: ${Array.isArray(params.team_name) ? params.team_name[0] : params.team_name}`}
        accessibilityLanguage="en-US"
        >
        {Array.isArray(params.team_name) ? params.team_name[0] : params.team_name}
        </Text>
        ...
        <View
            ...
            accessible={true}
            accessibilityLabel={`Project ${params.project_name}, Progress ${progress} percent`}
            accessibilityRole="summary"
            accessibilityLanguage="en-US"
        >
            <FontAwesome name="tasks" size={32} color={theme.text} />
            <Text
            style={[styles.SmolText, { paddingLeft: 10, color: theme.text }]}
            ...
            <View style={styles.container}>
                <View
                style={[styles.progressBackground, { backgroundColor: theme.card }]}
                accessible={true}
                accessibilityLabel={`Project completion progress: ${progress} percent`}
        ...
        <View style={styles.headerRow}>
            ...
            accessibilityHint="Opens the screen to create a new task"
            accessibilityLanguage="en-US"
            >
        ...
        <FlatList
            ...
            accessibilityLabel="List of tasks and subtasks"
            accessibilityLanguage="en-US"
            renderItem={({ item }) => (
            <View>
                <TaskItem task={item} />
